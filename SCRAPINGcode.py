...
GEMINI_API_KEY ='AIzaSyB_wSu-mzGiu3bHvnwxp9tTuE8KMX7acJA'  # set in .env
GITHUB_TOKEN = os.getenv("GITHUB_TOKEN", "")  # optional for higher GitHub rate limits
GMAIL_FROM_EMAIL = 'bytebreakers04@gmail.com'  # e.g., 'bytebreakers04@gmail.com'
GMAIL_APP_PASSWORD = 'mtdb asem sbat apah'  # Gmail app password
FIREBASE_CREDENTIALS_PATH = "coding-team-profiles-2b0b4df65b4a.json"
