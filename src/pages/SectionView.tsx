...
const SectionView: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (deptId && sectionId) {
      const sectionData = globalData.filter((d: any) => d.deptId === deptId && d.sectionId === sectionId);
      setData(sectionData);
      setStats(getTeamStats(sectionData));
    }
    setLoading(false);
  }, [globalData, globalLoading, deptId, sectionId]);
